...
const WHATSAPP_PRIMARY = "https://wa.me/923117312131"
const PHONE_PRIMARY = "tel:+923117312131"
...
const SERVICES = [
  { title: "Braces (Metal & Ceramic)", desc: "Expert metal and ceramic braces to straighten misaligned teeth and correct bite issues with precision and lasting results." },
  { title: "Clear Aligners", desc: "Comfortable, removable, and nearly invisible clear aligners — a modern alternative to traditional braces for a confident smile." },
  { title: "Teeth Whitening", desc: "Professional in-clinic whitening treatments to remove deep stains and brighten your smile by several shades in one visit." },
  { title: "Dental Implants", desc: "Permanent titanium implants that replace missing teeth with natural-looking, fully functional artificial roots." },
  { title: "Scaling & Polishing", desc: "Deep professional cleaning to remove hardened plaque and tartar, leaving your gums healthier and teeth cleaner." },
  { title: "Filling & Root Canal", desc: "Pain-free endodontic therapy and tooth-colored fillings to save infected or damaged teeth without extraction." },
  { title: "Crown & Bridges", desc: "Custom-fitted crowns and bridges that restore broken or missing teeth with lasting strength and natural aesthetics." },
  { title: "Tooth Extraction", desc: "Gentle and precise removal of damaged, decayed, or wisdom teeth with minimal discomfort and fast healing." },
  { title: "Aesthetic Dentistry", desc: "Complete smile makeovers including veneers, bonding, and cosmetic procedures to enhance your natural beauty." },
  { title: "Preventive Dentistry", desc: "Regular checkups, X-rays, and professional cleanings to detect and prevent dental issues before they become serious." },
  { title: "Fixed & Removable Dentures", desc: "High-quality full and partial dentures designed for comfort and function to restore your smile naturally." },
  { title: "Retainers", desc: "Custom post-treatment retainers to maintain your straightened teeth and protect your orthodontic results long-term." },
]

const TESTIMONIALS = [
  {
    name: "Ahsan Raza",
    area: "Sabzazar Colony, Multan",
    text: "Would highly recommend BraceTown for braces for anyone in Multan. Dr. Mirza is very professional and explains everything clearly.",
    stars: 5,
  },
  {
    name: "Zara Khalid",
    area: "Bosan Road, Multan",
    text: "Amazing experience at BraceTown! The clinic is futuristic and clean. The staff is highly skilled and very supportive throughout treatment.",
    stars: 5,
  },
  {
    name: "Usman Tariq",
    area: "Multan",
    text: "Best orthodontic clinic in Multan. State-of-the-art facility with highly skilled dental consultants. Very happy with my braces treatment!",
    stars: 5,
  },
  {
    name: "Saba Noor",
    area: "Sabzazar Colony",
    text: "Professional, clean, and the results are incredible. Dr. Mirza made me feel comfortable throughout the entire process. Highly recommended!",
    stars: 5,
  },
]
    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 flex items-center justify-between h-16">
        <a href="#home" className="flex items-center gap-2.5">
          ...
          <span className="font-bold text-slate-900 text-sm tracking-tight">BraceTown</span>
        </a>
        ...
        <div className="grid lg:grid-cols-[1fr_420px] gap-12 lg:gap-16 items-center">
          ...
          <div>
            <div className="flex items-center gap-2 mb-6">
              <Stars n={5} />
              <span className="text-slate-500 text-sm">5.0 — 45 Google Reviews</span>
            </div>
            ...
            <p className="text-slate-500 text-lg sm:text-xl mb-3 font-light">Futuristic & State-of-the-Art Dental Facility in Multan</p>

            <p className="text-slate-600 text-base sm:text-lg leading-relaxed mb-8 max-w-lg">
              Expert braces, aligners, and complete dental care by Dr. Mirza Ezaaf Shuja. Located at 1st Floor, Multan Clinics, Bosan Road, Multan.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 text-sm text-slate-500">
              <span className="flex items-center gap-1.5">
                ...
                1st Floor, Multan Clinics, Bosan Rd, Multan
              </span>
              <span className="flex items-center gap-1.5">
            ...
            <div className="relative">
              <div className="bg-slate-50 border border-slate-100 rounded-3xl p-6 space-y-4">
                <div className="flex items-center gap-3 pb-4 border-b border-slate-100">
                  ...
                  <div>
                    <p className="font-bold text-slate-900 text-sm">Dr. Mirza Ezaaf Shuja</p>
                    <p className="text-slate-400 text-xs">Orthodontist & Dental Consultant</p>
                  </div>
                </div>

                {[
                  { label: "Specialty", value: "Braces & Orthodontics" },
                  { label: "Status", value: "Highly Skilled Consultant" },
                  { label: "Google Rating", value: "5.0 ★" },
                  { label: "Patient Reviews", value: "45" },
                ].map(s => (
                ...
                <div className="pt-3 border-t border-slate-100">
                  <div className="bg-teal-600 rounded-2xl p-4 text-white">
                    ...
                    <p className="text-teal-200 text-xs">Call 0311-7312131 to reserve your slot today</p>
                  </div>
                </div>
              </div>
        ...
        <div className="grid lg:grid-cols-[420px_1fr] gap-12 lg:gap-16 items-start">
          ...
          <div className="relative">
            <div className="rounded-2xl overflow-hidden bg-slate-200 aspect-[3/4]">
              <img
                src={drKamranPhoto}
                alt="Dr. Mirza Ezaaf Shuja at BraceTown Dental Practice Multan"
            ...
            <div className="absolute -bottom-5 right-5 bg-white rounded-2xl shadow-lg border border-slate-100 px-5 py-4">
              ...
              <p className="text-slate-400 text-xs">45 Google Reviews</p>
            </div>
          </div>

          {/* Content */}
          <div className="pt-2 lg:pt-8">
            <p className="text-teal-600 text-sm font-semibold uppercase tracking-widest mb-3">About the Clinic</p>
            <h2 className="section-heading text-4xl sm:text-5xl text-slate-900 leading-tight mb-6">
              Dr. Mirza Ezaaf Shuja
            </h2>

            <p className="text-slate-600 text-lg leading-relaxed mb-4">
              Dr. Mirza Ezaaf Shuja is a highly skilled <strong className="text-slate-800">Orthodontist & Dental Consultant</strong> at BraceTown Dental Practice — a futuristic and state-of-the-art dental facility in Multan.
            </p>
            <p className="text-slate-500 leading-relaxed mb-6">
              BraceTown specializes in braces (metal & ceramic), clear aligners, teeth whitening, implants, root canals, scaling, and a full range of restorative and cosmetic dental procedures. Located at 1st Floor, Multan Clinics, Bosan Road, Sabzazar Colony, Multan.
            </p>
            <p className="text-slate-500 leading-relaxed mb-8">
              Whether you need braces, a smile makeover, or routine dental care — BraceTown ensures a comfortable, professional, and modern dental experience every visit.
            </p>

            <dl className="grid sm:grid-cols-2 gap-4 mb-8">
              {[
                { label: "Doctor", value: "Dr. Mirza Ezaaf Shuja" },
                { label: "Specialty", value: "Braces & Orthodontics" },
                { label: "Location", value: "Bosan Rd, Multan" },
                { label: "Availability", value: "Mon–Fri: 5 PM to 9 PM" },
              ].map(item => (
      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-8 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        <div>
          ...
          <p className="text-slate-500 leading-relaxed text-lg mb-10">
            BraceTown Dental Practice is a futuristic, state-of-the-art facility equipped with the latest technology and highly skilled dental consultants delivering outstanding results.
          </p>
            ...
            {[
              {
                ...
                body: "Dr. Mirza Ezaaf Shuja is a specialist orthodontist offering metal, ceramic braces and clear aligners for all ages.",
              },
              {
                title: "5.0 rating, 45 reviews",
                body: "Consistent five-star ratings on Google from over 45 highly satisfied patients across Multan.",
              },
              {
                title: "Futuristic Facility",
                body: "State-of-the-art clinic with modern equipment, a clean hygienic environment, and highly trained dental consultants.",
              },
              {
                title: "Convenient Evening Hours",
                body: "Clinic is open Monday to Friday from 5 PM to 9 PM — perfect for working professionals and students.",
              },
              {
                title: "Full range under one roof",
                body: "Braces, aligners, whitening, implants, root canals, scaling, crowns, retainers — all at BraceTown.",
              },
            ].map(item => (
        ...
        <div className="grid grid-cols-2 gap-3">
          {[
            { big: "Braces", label: "Specialist Care", sub: "Metal & Ceramic" },
            { big: "5.0★", label: "Google Rating", sub: "45 Reviews" },
            { big: "Till 9 PM", label: "Mon to Fri", sub: "Evening Hours" },
          ...
          <div className="col-span-2 bg-amber-50 border border-amber-100 rounded-2xl p-5">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-slate-700 text-sm leading-relaxed italic">"Would highly recommend BraceTown for braces for anyone in Multan. Dr. Mirza is very professional and explains everything clearly."</p>
    ...
    <section id="gallery" className="py-20 sm:py-28 bg-white">
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <div className="flex items-end justify-between mb-10 gap-4 flex-wrap">
          ...
          <a href="https://www.instagram.com/bracetowndental/" target="_blank" rel="noopener noreferrer"
    ...
    <section id="reviews" className="py-20 sm:py-28 bg-slate-50">
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        ...
        <div className="mt-8 text-center">
          <a href="https://www.google.com/maps/search/BraceTown+Dental+Practice+Multan/" target="_blank" rel="noopener noreferrer"
...
function AppointmentSection() {
  ...
  const submit = (e: React.FormEvent) => {
    ...
    const msg = encodeURIComponent(
      `Assalam o Alaikum! I'd like to book an appointment at BraceTown Dental Practice.\n\nName: ${form.name}\nPhone: ${form.phone}${form.date ? `\nDate: ${form.date}` : ''}${form.time ? `\nTime: ${form.time}` : ''}${form.message ? `\nNote: ${form.message}` : ''}`
    )
    window.open(`https://wa.me/923117312131?text=${msg}`, '_blank')
    setSent(true)
      ...
      <div className="max-w-5xl mx-auto px-5 sm:px-8 grid lg:grid-cols-[1fr_440px] gap-12 items-start">
        <div>
          ...
          <p className="text-slate-500 leading-relaxed mb-8 text-lg">
            Fill the form and we'll send the details to Dr. Mirza's WhatsApp. We'll confirm your slot. Walk-ins also welcome (Mon–Fri, 5 PM to 9 PM).
          </p>

          <div className="space-y-3">
            {[
              { icon: "phone", label: "Call", val: "0311-7312131", href: "tel:+923117312131" },
              { icon: "wa", label: "WhatsApp", val: "0311-7312131", href: WHATSAPP_PRIMARY },
            ].map(c => (
        ...
        <div className="bg-slate-50 border border-slate-100 rounded-2xl p-6 sm:p-7">
          {sent ? (
            <div className="text-center py-8">
              ...
              <p className="text-slate-500 text-sm">Your appointment request is ready to send to BraceTown Dental on WhatsApp.</p>
            </div>
          ) : (
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          <div className="space-y-4">
            <div className="bg-white border border-slate-100 rounded-2xl p-5">
              <p className="text-slate-800 font-semibold mb-1">1st Floor, Multan Clinics</p>
              <p className="text-slate-600 text-sm">Bosan Road, Sabzazar Colony</p>
              <p className="text-slate-500 text-sm">Multan, 66000</p>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white border border-slate-100 rounded-2xl p-5">
                <p className="text-xs text-slate-400 uppercase tracking-wider mb-3 font-medium">Phone</p>
                <a href="tel:+923117312131" className="block text-slate-800 font-semibold text-sm hover:text-teal-600 transition-colors mb-1">0311-7312131</a>
              </div>
              <div className="bg-white border border-slate-100 rounded-2xl p-5">
                <p className="text-xs text-slate-400 uppercase tracking-wider mb-3 font-medium">Hours</p>
                <p className="text-slate-800 font-semibold text-sm">Mon–Fri</p>
                <p className="text-slate-500 text-sm">5 PM to 9 PM</p>
              </div>
            </div>
            <div className="bg-white border border-slate-100 rounded-2xl p-5">
              ...
              <div className="flex gap-3">
                ...
                <a href="https://www.facebook.com/bracetowndentalpractice/" target="_blank" rel="noopener noreferrer"
                  className="flex items-center gap-2 text-sm text-slate-600 hover:text-teal-600 transition-colors">
          ...
          <div className="rounded-2xl overflow-hidden border border-slate-100 bg-slate-100" style={{ minHeight: 380 }}>
            <iframe
              title="BraceTown Dental Practice location"
              src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=BraceTown+Dental+Practice+Bosan+Road+Multan&amp;t=&amp;z=15&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
              width="100%"
              height="100%"
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          <div className="lg:col-span-2">
            <p className="font-bold text-white text-base mb-1">BraceTown Dental Practice</p>
            <p className="text-teal-400 text-sm mb-4">Futuristic & State-of-the-Art Dental Facility</p>
            <p className="text-sm leading-relaxed max-w-xs">
              Expert braces, aligners, and complete dental care by Dr. Mirza Ezaaf Shuja. 1st Floor, Multan Clinics, Bosan Road, Multan.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>0311-7312131</li>
              <li className="leading-snug">1st Floor, Multan Clinics, Bosan Rd, Multan</li>
              <li className="text-teal-400">Mon–Fri: 5 PM to 9 PM</li>
            </ul>
          </div>
        </div>

        <div className="border-t border-slate-800 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
          <p>© 2026 BraceTown Dental Practice. All rights reserved.</p>
